...
```yml
# Site settings
title: Axming Blog             # title of your website
SEOTitle: Axming Blog          # check out docs for more detail
...
For instance, [Hello 2015])(https://zmy1123347389.github.io/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://zmy1123347389.github.io/2019/09/08/spacemacs-workflow/) with
...
![](http://zmy1123347389.github.io/img/blog-sidebar.jpg)
...
![](http://zmy1123347389.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://zmy1123347389.github.io/js-module-7day/"
---
```
...
ga_domain: zmy1123347389.github.io
```
...
It's possible that you want the two things different. For me, my site-title is **“Axming Blog”** but I want the title shows in search engine is **“黄玄的博客 | Axming Blog”** which is multi-language.
...
- Brand new [Archive](https://zmy1123347389.github.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
<img src="http://zmy1123347389.github.io/img/blog-md-navbar.gif" width="320" />
